...
|-------------|----------------|------------------------------------------------------|
| Node        | 20.3.0         | [Install](https://nodejs.org/en/download)  |
| Node Package Manager (npm)   | 9.6.7          | [Install](https://docs.npmjs.com/downloading-and-installing-node-js-and-npm) |
...
[GitHub Issues](https://github.com/kirahsapong/create-web5/issues).
